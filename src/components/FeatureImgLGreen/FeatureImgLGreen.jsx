...
const FeatureImgLGreen = ({ ImgLink, alt, Title, Tag, Subtitle, link, Button }) => {
    return (
            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-12 col-lg-6 p-3 order-sm-1'>
                        <h3 className='featureImgLGreen__Title'>{Title}</h3>
                        <h1 className='featureImgLGreen__Tag'>{Tag}</h1>
